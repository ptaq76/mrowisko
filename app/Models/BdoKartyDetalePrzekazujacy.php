...
class BdoKartyDetalePrzekazujacy extends Model
{
    protected $table = 'bdo_karty_detale_przekazujacy';
    ...
    {
        return $this->belongsTo(BdoKartyPrzekazujacy::class, 'kpo_id', 'kpo_id');
    }
}
