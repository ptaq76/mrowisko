...
return new class extends Migration
{
    ...
    {
        // ══════════════════════════════════════════════════════════════════════
        // TABELA GŁÓWNA: bdo_karty (karty odpadów - pozycja przejmującego)
        // ══════════════════════════════════════════════════════════════════════
        Schema::create('bdo_karty', function (Blueprint $table) {
            $table->id();
        ...
        // ══════════════════════════════════════════════════════════════════════
        // TABELA SZCZEGÓŁÓW: bdo_karty_detale
        // ══════════════════════════════════════════════════════════════════════
        Schema::create('bdo_karty_detale', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bdo_karty_detale');
        Schema::dropIfExists('bdo_karty');
    }
};
