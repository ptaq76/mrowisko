...
.bar-planned  { background: var(--yellow); }
...
.bar-client {
    ...
    color: #111; line-height: 1; flex: 1;
    text-transform: uppercase;
}
.bar-status {
    font-size: 10px; font-weight: 700; letter-spacing: .08em;
    text-transform: uppercase;
    background: rgba(0,0,0,.15); color: #111;
...
.bar-action:active { background: rgba(255,255,255,.7); }
...
.ws-label { font-size: 11px; font-weight: 700; color: #935810; text-transform: uppercase; letter-spacing: .06em; }
.ws-val   { font-family: 'Barlow Condensed', sans-serif; font-size: 22px; font-weight: 900; color: #935810; }
...
<div class="order-card" style="opacity:.5">
    <div class="order-bar bar-done">
        <div class="bar-client" style="color:#555">{{ $order->client?->short_name }}</div>
