...
<style>
    ...
    .btn-filter:active { background: var(--green-dark); }
    .btn-clear {
...
<form method="GET" action="{{ route('plac.reports.deliveries') }}">
    <div class="filter-bar">
        <div>
            <label>Klient (dostawca)</label>
        ...
        <div class="filter-actions">
            <a href="{{ route('plac.reports.deliveries') }}" class="btn-clear" style="flex:1; justify-content:center">
...
@if($orders->isEmpty())
    <div class="empty-state">
        <i class="fas fa-boxes"></i>
        <p style="font-size:14px; font-weight:600; margin:0">Brak dostaw do wyświetlenia</p>
    </div>
@else
