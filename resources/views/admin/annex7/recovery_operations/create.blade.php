...
@section('title', 'Annex 7 – Nowa operacja odzysku')
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.annex7-recovery-operations.store') }}">
            @csrf
            @include('admin.annex7.recovery_operations._form')
