...
@section('title', 'Annex 7 – Nowy kontrahent')
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.annex7-contractors.store') }}">
            @csrf
            @include('admin.annex7.contractors._form')
