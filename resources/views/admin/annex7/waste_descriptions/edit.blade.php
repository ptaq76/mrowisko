...
@section('title', 'Annex 7 – Edycja opisu odpadu')
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.annex7-waste-descriptions.update', $annex7WasteDescription) }}">
            @csrf @method('PUT')
            @include('admin.annex7.waste_descriptions._form', ['wasteDescription' => $annex7WasteDescription])
