...
@section('nav_menu')
    <a href="{{ route('biuro.planning.index') }}" class="btn">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{ route('biuro.clients.index') }}">
                <i class="fa-solid fa-list"></i> Lista kontrahentów
            </a></li>
        </ul>
    </div>
    <a href="{{ route('biuro.ls.index') }}" class="btn">
        <i class="fa-solid fa-id-badge"></i> Lieferschein
    </a>
    <div class="dropdown">
        <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{ route('biuro.fractions.index') }}">
                ...
                <div class="order-card-body">
                    ...
                    <div class="order-col-actions">
                        <div class="status-btns">
                            ...
                            @php $isActive = $currentIdx !== false && array_search($statusKey, $statusOrder) <= $currentIdx; @endphp
                            <button class="btn-status-sm {{ $isActive ? 'active' : '' }}"
