...
.filter-group select:focus { border-color:#6EBF58; }
.btn-filter { padding:8px 18px;background:#6EBF58;color:#fff;border:none;border-radius:7px;font-size:13px;font-weight:700;cursor:pointer; }
...
.cell-plate { font-size:11px;font-weight:700;color:#888; }
...
<div class="report-wrap">
    ...
    <div class="report-header">
        <div class="report-title">
            <i class="fas fa-archive" style="color:#f39c12"></i>
            Archiwum Załadunków
        </div>
                    ...
                    <td>
                        ...
                        <table class="goods-table">
                            ...
                            <tr class="goods-sum">
                                ...
                                <td class="g-weight">{{ number_format($totalEstKg / 1000, 3, ',', ' ') }} t</td>
                            </tr>
                        </table>
                        @endif
                    </td>
